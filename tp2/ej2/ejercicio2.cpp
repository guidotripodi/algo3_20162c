...
int main() {
    ...
    char map[] = {'#','#','#','#','#','#','#','#','#','#','#','#','#','#','#','#','#','#','#','#','#','#','#','#','#','#','#','#','#','#','#','#','#','#','#','#','#','#','#','#','#','#','#','#','#','#','#','#','#','#','#','#','#',
'#','.','#','.','#','.','#','.','#','.','#','.','#','.','#','.','#','.','#','.','#','.','#','.','#','.','#','.','#','.','#','.','#','.','#','.','#','.','#','.','#','.','#','.','#','.','#','.','#','.','#','.','#',
'#','.','9','.','2','.','4','.','6','.','8','.','1','.','3','.','5','.','7','.','9','.','2','.','4','.','6','.','8','.','1','.','3','.','5','.','7','.','9','.','2','.','4','.','6','.','8','.','1','.','3','.','#',
'#','.','#','.','#','.','#','.','#','.','#','.','#','.','#','.','#','.','#','.','#','.','#','.','#','.','#','.','#','.','#','.','#','.','#','.','#','.','#','.','#','.','#','.','#','.','#','.','#','.','#','.','#',
'#','.','7','.','9','.','2','.','4','.','6','.','8','.','1','.','3','.','5','.','7','.','9','.','2','.','4','.','6','.','8','.','1','.','3','.','5','.','7','.','9','.','2','.','4','.','6','.','8','.','1','.','#',
'#','.','#','.','#','.','#','.','#','.','#','.','#','.','#','.','#','.','#','.','#','.','#','.','#','.','#','.','#','.','#','.','#','.','#','.','#','.','#','.','#','.','#','.','#','.','#','.','#','.','#','.','#',
'#','.','5','.','7','.','9','.','2','.','4','.','6','.','8','.','1','.','3','.','5','.','7','.','9','.','2','.','4','.','6','.','8','.','1','.','3','.','5','.','7','.','9','.','2','.','4','.','6','.','8','.','#',
'#','.','#','.','#','.','#','.','#','.','#','.','#','.','#','.','#','.','#','.','#','.','#','.','#','.','#','.','#','.','#','.','#','.','#','.','#','.','#','.','#','.','#','.','#','.','#','.','#','.','#','.','#',
'#','.','3','.','5','.','7','.','9','.','2','.','4','.','6','.','8','.','1','.','3','.','5','.','7','.','9','.','2','.','4','.','6','.','8','.','1','.','3','.','5','.','7','.','9','.','2','.','4','.','6','.','#',
'#','.','#','.','#','.','#','.','#','.','#','.','#','.','#','.','#','.','#','.','#','.','#','.','#','.','#','.','#','.','#','.','#','.','#','.','#','.','#','.','#','.','#','.','#','.','#','.','#','.','#','.','#',
'#','.','1','.','3','.','5','.','7','.','9','.','2','.','4','.','6','.','8','.','1','.','3','.','5','.','7','.','9','.','2','.','4','.','6','.','8','.','1','.','3','.','5','.','7','.','9','.','2','.','4','.','#',
'#','.','#','.','#','.','#','.','#','.','#','.','#','.','#','.','#','.','#','.','#','.','#','.','#','.','#','.','#','.','#','.','#','.','#','.','#','.','#','.','#','.','#','.','#','.','#','.','#','.','#','.','#',
'#','.','8','.','1','.','3','.','5','.','7','.','9','.','2','.','4','.','6','.','8','.','1','.','3','.','5','.','7','.','9','.','2','.','4','.','6','.','8','.','1','.','3','.','5','.','7','.','9','.','2','.','#',
'#','.','#','.','#','.','#','.','#','.','#','.','#','.','#','.','#','.','#','.','#','.','#','.','#','.','#','.','#','.','#','.','#','.','#','.','#','.','#','.','#','.','#','.','#','.','#','.','#','.','#','.','#',
'#','.','6','.','8','.','1','.','3','.','5','.','7','.','9','.','2','.','4','.','6','.','8','.','1','.','3','.','5','.','7','.','9','.','2','.','4','.','6','.','8','.','1','.','3','.','5','.','7','.','9','.','#',
'#','.','#','.','#','.','#','.','#','.','#','.','#','.','#','.','#','.','#','.','#','.','#','.','#','.','#','.','#','.','#','.','#','.','#','.','#','.','#','.','#','.','#','.','#','.','#','.','#','.','#','.','#',
'#','.','4','.','6','.','8','.','1','.','3','.','5','.','7','.','9','.','2','.','4','.','6','.','8','.','1','.','3','.','5','.','7','.','9','.','2','.','4','.','6','.','8','.','1','.','3','.','5','.','7','.','#',
'#','.','#','.','#','.','#','.','#','.','#','.','#','.','#','.','#','.','#','.','#','.','#','.','#','.','#','.','#','.','#','.','#','.','#','.','#','.','#','.','#','.','#','.','#','.','#','.','#','.','#','.','#',
