Para solucionar este problema, se debe ver la combinacion de viajes entre lados del puente (lado A, origen y lado B, destino) que nos permiten pasar a todos los integrantes
