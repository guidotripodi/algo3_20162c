...
\begin{figure} [!ht]
 ...
 \includegraphics[width=0.5\textwidth]{./EJ2/random.png}
       \label{fig:anilloexacto}}
  \subfloat[Error relativo]{
   \includegraphics[width=0.5\textwidth]{./EJ2/randomError.png}
    \label{fig:anillogoloso}}
    \end{figure}
...
\begin{figure} [!ht]
 \centering
  \subfloat[Comparación solución golosa vs exacta]{
 \includegraphics[width=0.5\textwidth]{./EJ2/familia.png}
       \label{fig:anilloexacto}}
  \subfloat[Error relativo]{
   \includegraphics[width=0.5\textwidth]{./EJ2/familiaError.png}
    \label{fig:anillogoloso}}
    \end{figure}
...
\\{\textit{Errores relativos por familia}}
\end{center}
