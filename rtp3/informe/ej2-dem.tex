...
GRAFICOS DE BARRAS CON DISTANCIA EXACTA Y GOLOSA - LOS ERRORES SON PARA DESPUES!
...
--> INDICAR LA CONSTANTE: MELANIE LO PIDIO

\subsubsection*{Repercusi\'on del tamaño de la mochila en el algoritmo hasta 16 elementos (pokeparadas + gimnasios)}

PARA LOS CASOS CHICOS SE PUEDE MOSTRAR LA REPERCUSION DE LA MOCHILA!!! ESTOS DATOS LOS TIENEN
...
Para el caso del valor de la mochila, con más de 16 elementos solo se analizará tomando el mínimo, y hasta con 16 elementos, podremos comparar contra el exacto que resulta de tomar la peor o la mejor mochila.\\ <-- SI, HAY QUE TOMAR STRONG Y WEAK HASTA 16 ELTOS Y COMPARAR CONTRA EL EXACTO!!\\
...
PRESENTAR LAS FAMILIAS RANDOM Y FAMILIAS POR CUADRANTE

ESTE GRAFICO PARA MOSTRAR LA RANDOM Y PODEMOS GENERAR UNO PARA MOSTRAR LA QUE ES POR CUADRANTE
\begin{figure} [!ht]
 \centering
  \subfloat[Algoritmo exacto]{
